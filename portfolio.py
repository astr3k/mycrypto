...
def main():
    ...
    print("{:<7}  {:<16}  {:<20}  {:<8}  {:<55}  {:<21}  {:<19}".format(
    ...
    for row in all_coins:
        ...
        print("{:<7}  {:>9.2f}  {:>5.2f}  {:<15}  {:>3}  {:>8.2f}  {:>9.2f}  {:>9.2f}  {:>11.8f}  {:>9.2f}  {:>9.2f}  {:>9.2f}  {:>10.8f}  {:>9.2f}  {:>6.2f}".format(
    ...
    print("{:<7}  {:<16}  {:<20}  {:<8}  {:<55}  {:<21}  {:<19}".format(
    "-------", "----------------", "--------------------", "--------", "-------------------------------------------------------", "---------------------", "-----------------"))
    print("{:<7}  {:>9.2f}  {:>5}  {:<20}  {:<8}  {:<9}  {:<9}  {:<11}  {:>9.2f}  {:>9.2f}  {:>9.2f}  {:>10.8f}  {:>9.2f}  {:>6.2f}".format(
